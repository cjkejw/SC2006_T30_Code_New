...
{
    /// <inheritdoc />
    public partial class typechangesmade : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectInterests = table.Column<string>(type: "text", nullable: false),
                    CCA = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "19401fab-0898-4bef-b9f6-2bf18f4ff0a6", null, "Admin", "ADMIN" },
                    { "7ddc69ae-7c20-4081-a5b7-9c9f16bb4a97", null, "User", "USER" }
                });
